...
export interface ApiAboutInfoAboutInfo extends Schema.SingleType {
  ...
  attributes: {
    ...
    aboutImg: Attribute.Media;
    aboutDesc: Attribute.Text;
    introMsg: Attribute.Text;
    introTitle: Attribute.String;
    introDesc: Attribute.Text;
    partnershipLink: Attribute.String;
    mission: Attribute.Component<'mission-statement.mission-and-vision', true>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
...
export interface ApiContactLinkContactLink extends Schema.CollectionType {
  ...
  attributes: {
    ...
    type: Attribute.Enumeration<['call', 'email', 'location']>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
...
export interface ApiFooterLinkFooterLink extends Schema.SingleType {
  ...
  attributes: {
    desc: Attribute.Text;
    contact_links: Attribute.Relation<
...
export interface ApiHeroInfoHeroInfo extends Schema.SingleType {
  collectionName: 'hero_infos';
  info: {
    singularName: 'hero-info';
    pluralName: 'hero-infos';
...
export interface ApiSpeakerSpeaker extends Schema.CollectionType {
  ...
  attributes: {
    ...
    imgLink: Attribute.String;
    handle: Attribute.Component<'speaker-handle.speaker', true>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
...
export interface ApiSponsorSponsor extends Schema.CollectionType {
  ...
  info: {
    ...
    pluralName: 'sponsors';
    displayName: 'Sponsor';
    description: 'The sponsor for this event';
  };
  options: {
    draftAndPublish: true;
  };
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::hero-info.hero-info': ApiHeroInfoHeroInfo;
